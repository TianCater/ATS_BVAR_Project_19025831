...
```
    ...
    ## Finished MCMC after 31.28 secs.
...
```
    ...
    ## constant     0.125  0.289  4.412  0.129
    ## NGDP-lag1    1.007  0.003  0.155 -0.008
    ## HEX_pc-lag1  0.019  1.036  0.652  0.026
    ## LIFEE-lag1  -0.002 -0.005  0.925 -0.002
    ## AI-lag1      0.000  0.006 -0.063  1.005
    ## 
    ...
    ## LIFEE  0.000  0.000 1.252 0.002
    ## AI     0.000  0.000 0.002 0.853
    ## 
    ## Log-Likelihood: -100.5619
